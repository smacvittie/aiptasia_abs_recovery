...
Fig1<-Fig1B +guides(color = F, fill=F) + Fig1C + Fig1D +guides(color=F, fill=F)+ Fig1E + plot_layout(ncol=2, design=layout, guides='collect')
Fig1  
ggsave('Figures/Fig1.pdf',width=8,height=8, bg= 'transparent')
